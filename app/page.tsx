...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 relative overflow-hidden px-4 sm:px-6 transition-colors duration-200">
      ...
      <p className="text-gray-600 dark:text-gray-300 mb-6 text-center max-w-sm text-sm sm:text-base px-4">
        Smart hierarchical project management with AI-powered insights and seamless team collaboration.
      </p>

      {/* Animated Loader */}
      <div className="flex gap-2">
        <span className="w-3 h-3 bg-blue-500 dark:bg-blue-400 rounded-full animate-bounce [animation-delay:-0.3s]"></span>
        <span className="w-3 h-3 bg-indigo-500 dark:bg-indigo-400 rounded-full animate-bounce [animation-delay:-0.15s]"></span>
        <span className="w-3 h-3 bg-purple-500 dark:bg-purple-400 rounded-full animate-bounce"></span>
      </div>
