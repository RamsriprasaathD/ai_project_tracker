...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 text-white">
      ...
      <div className="w-full max-w-md p-8 backdrop-blur-xl bg-gradient-to-b from-gray-900/70 to-gray-800/60 rounded-2xl shadow-[0_0_40px_rgba(0,0,0,0.7)] border border-gray-700/60 hover:shadow-[0_0_50px_rgba(0,150,255,0.25)] transition duration-300">
        {/* Title */}
